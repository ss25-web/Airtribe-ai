...
const BADGES = [
  { id: 'genai-m7-lastmile',    icon: 'LM', label: 'Last Mile',    color: '#B45309', bg: '#FEF3C7', border: '#FDE68A' },
  { id: 'genai-m7-anatomy',     icon: 'AN', label: 'Anatomy',      color: '#2563EB', bg: '#EFF6FF', border: '#BFDBFE' },
  { id: 'genai-m7-build',       icon: 'BT', label: 'Tool Builder', color: '#0891B2', bg: '#ECFEFF', border: '#A5F3FC' },
  { id: 'genai-m7-permissions', icon: 'SC', label: 'Scoper',       color: '#059669', bg: '#ECFDF5', border: '#A7F3D0' },
  { id: 'genai-m7-production',  icon: 'PR', label: 'Prod Ready',   color: '#7C3AED', bg: '#F5F3FF', border: '#DDD6FE' },
];
...
export default function GenAIPreRead7({ track, onBack }: Props) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--ed-bg)', color: 'var(--ed-ink)' }}>
      {/* Top Nav */}
      <div style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(var(--ed-bg-rgb),0.92)', borderBottom: '1px solid var(--ed-rule)', backdropFilter: 'blur(12px)' }}>
