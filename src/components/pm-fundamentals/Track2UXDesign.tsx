    ...
    <article style={{ maxWidth: '740px', margin: '0 auto', padding: '0 24px 80px' }}>
      ...
      <ChapterSection id="m4-apm-demo" num="01" accentRgb={ACCENT_RGB} first>
        ...
        <Avatar
          ...
          nameColor="#4F46E5"
          borderColor="#4F46E5"
          content={<>That question wasn&apos;t about design. It was about trust. Enterprise procurement teams are looking for reasons to say no. Inconsistency is an easy one.</>}
          expandedContent="Enterprise clients deploy to hundreds or thousands of users. A visually inconsistent product signals undisciplined engineering culture — which implies harder integrations, more support tickets, and slower iterations. The Infosys lead wasn't being difficult. She was doing her job."
      ...
      <ChapterSection id="m4-apm-audit" num="02" accentRgb={ACCENT_RGB}>
        ...
        <Avatar
          ...
          nameColor="#3A86FF"
          borderColor="#3A86FF"
          content={<>The data doesn&apos;t distinguish between &ldquo;ugly&rdquo; and &ldquo;confusing.&rdquo; But the users do. A non-standard UI element isn&apos;t just visually off &mdash; it breaks the user&apos;s muscle memory. And broken muscle memory costs you a completion.</>}
          expandedContent="Every platform builds user expectation over time. Users develop a mental model of how your product behaves. When one screen uses a different pattern, the user has to switch from automatic to deliberate — and in that moment of deliberateness, they notice everything that's slightly wrong. Inconsistency doesn't just look unprofessional. It creates cognitive friction that interrupts the flow state that's essential for adoption."
      ...
      <ChapterSection id="m4-apm-ds-decision" num="03" accentRgb={ACCENT_RGB}>
        ...
        <Avatar
          ...
          nameColor="#C85A40"
          borderColor="#C85A40"
          content={<>I&apos;m not asking for six weeks to make things pretty. I&apos;m asking for six weeks so that every feature after this takes half the time. You&apos;re not pausing — you&apos;re buying speed.</>}
          expandedContent="A design system is a force multiplier. The first feature built with it might take just as long — but every subsequent one gets faster, more consistent, and cheaper to change. The real cost of not having one isn't the design quality today. It's the velocity penalty paid on every feature for the rest of the product's life."
      ...
      <ChapterSection id="m4-apm-critique" num="04" accentRgb={ACCENT_RGB}>
        ...
        <Avatar
          ...
          nameColor="#0097A7"
          borderColor="#0097A7"
          content={<>The test for PM critique feedback: can you trace it back to a user need or a business outcome? If not, it&apos;s a preference. Preferences are fine in your head. In a critique, they cost the team a design decision without gaining them any insight.</>}
          expandedContent="Design is full of valid trade-offs that aren't visible from outside the design process. When a PM gives preference-based feedback, they foreclose those trade-offs without understanding them. When a PM gives goal-based feedback, they give the designer the information they need to make the right trade-off themselves. The second approach produces better design and a better working relationship."
      ...
      <ChapterSection id="m4-apm-threshold" num="05" accentRgb={ACCENT_RGB}>
        ...
        <Avatar
          ...
          nameColor="#6E7681"
          borderColor="#6E7681"
          content={<>I can build the animation. I need to know if it&apos;s worth two days. That&apos;s your call, not mine.</>}
          expandedContent="Engineers often have opinions about what's worth building carefully — but they need the PM to provide the context of where users spend attention and what the business prioritises. 'Worth it' is not a design judgement. It's a product judgement that needs user frequency data, business context, and delivery constraint awareness."
      ...
      <ChapterSection id="m4-apm-pitch" num="06" accentRgb={ACCENT_RGB}>
        ...
        <Avatar
          ...
          nameColor="#0097A7"
          borderColor="#0097A7"
          content={<>The strongest design investment pitch doesn&apos;t argue for design. It argues for velocity, revenue, and client retention &mdash; and shows that a design system is the mechanism.</>}
          expandedContent="There's a critical sequence in any investment pitch to a skeptical CEO: show the cost of the status quo first (makes the problem real and urgent), then show the ROI of the proposed investment (makes approval feel safe), then show the implementation plan (removes the fear of disruption). Leading with the plan before establishing urgency produces nodding but no action."
