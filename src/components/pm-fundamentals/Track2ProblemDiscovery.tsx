  ...
  return (
    <article>
      ...
      <ChapterSection id="m2-reflection" num="07" accentRgb="0,151,167">
        ...
        <ApplyItBox prompt="Take a product you use or work on. Pick one customer complaint or support ticket. Write the problem statement in one sentence: who is affected, what they cannot do, and what the measurable consequence is. Is the problem statement different from the original complaint?" />
