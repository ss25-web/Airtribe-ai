...
// Modules without `preReadNum` render as Coming Soon. Builder + Engineer
// share Phase 1 Foundations (PR1-PR3); past that, the tracks diverge.
...
const ENGINEER_MODULES = [
  ...
  {
    num: '06',
    phase: 'Phase 3 · Build AI Features',
  ...
  {
    num: '10',
    phase: 'Phase 4 · Production AI Engineering',
